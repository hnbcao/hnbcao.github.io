...
canal.admin.passwd = 436ADFAD4F71E49B2E38A8F3A09525B9CD850989 # admin密码，从canal_manager库中获取
# admin auto register
canal.admin.register.auto = true
canal.admin.register.cluster = databench-pro # 集群名，admin部署步骤的最后一步配置中新增的集群名


canal.zkServers = 10.75.8.152:2181 # zk地址，admin部署步骤的最后一步配置中新增的集群的zk地址。
# flush data to zk
